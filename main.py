...
def load_tokenizer():
    return BertTokenizer.from_pretrained('SkolkovoInstitute/russian_toxicity_classifier')

# uload model
@st.cache(allow_output_mutation=True)
def load_model():
    return BertForSequenceClassification.from_pretrained('SkolkovoInstitute/russian_toxicity_classifier')
